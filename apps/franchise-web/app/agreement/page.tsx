...
export const metadata: Metadata = { title: 'Franchise Partner Agreement | JebDekho' };
...
async function loadAgreement(): Promise<Doc | null> {
  try {
    const res = await fetch(`${getApiBaseUrl()}/legal/documents/FRANCHISE_AGREEMENT`, {
      next: { revalidate },
    });
...
export default async function FranchiseAgreementPage() {
