...
/**
 * Step 1 of "set a password": send a PASSWORD_RESET OTP to the partner's phone.
 *
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Swallow 4xx: revealing "no such user" would leak who our partners are.
  }
  return NextResponse.json({
    success: true,
    message: 'If that number belongs to a partner, an OTP has been sent.',
  });
}
