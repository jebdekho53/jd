/** Kept word-for-word in sync with apps/buyer-web/content/help-content.ts so
 *  the answers a buyer gets are the same on both surfaces. */

export interface FaqItem {
  q: string;
  a: string;
  category: 'general' | 'orders' | 'payment' | 'refund' | 'delivery';
}
...
export const HELP_SECTIONS = [
  { id: 'orders', title: 'Orders', description: 'Track, cancel, and manage your orders' },
  {
    id: 'payment',
    title: 'Payments',
...
export const SUPPORT_EMAIL = 'support@jebdekho.com';
