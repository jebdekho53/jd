...
export class AppErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    const normalized = normalizeError(error, { componentStack: info.componentStack ?? undefined });
    // eslint-disable-next-line no-console
    console.error('[buyer-mobile] Unhandled error', normalized);
  }
      ...
      return (
        <View style={styles.container}>
          ...
          <Text style={styles.message}>
            The app hit an unexpected error. Tap below to retry.
          </Text>
