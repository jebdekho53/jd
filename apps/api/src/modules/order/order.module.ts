...
@Module({
  imports: [RiderAssignmentModule, LogisticsModule, CheckoutModule, InventoryModule, WalletLoyaltyModule, FinanceModule, ComplianceModule, PushModule, PaymentModule, DeliveryTrackingModule, LegalModule],
