...
export declare function isDemoPhone(phone: string, cfg: ReturnType<typeof getConfig>): boolean;
export declare function isDemoEmail(email: string, cfg: ReturnType<typeof getConfig>): boolean;
export declare function isDemoAuthRequest(body: {
    phone?: string;
    email?: string;
} | undefined, cfg: ReturnType<typeof getConfig>): boolean;
export declare function getDemoConfig(configService: ConfigService): {
