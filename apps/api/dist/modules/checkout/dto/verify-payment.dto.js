...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'order_Xxxxxxxxxxxxx', description: 'Razorpay order ID' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], VerifyPaymentDto.prototype, "razorpayOrderId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'pay_Xxxxxxxxxxxxx', description: 'Razorpay payment ID' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], VerifyPaymentDto.prototype, "razorpayPaymentId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'HMAC-SHA256 signature from Razorpay' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
