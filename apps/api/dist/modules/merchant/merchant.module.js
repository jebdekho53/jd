...
exports.MerchantModule = MerchantModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [merchant_service_1.MerchantService, verification_blocklist_service_1.VerificationBlocklistService],
        exports: [merchant_service_1.MerchantService, verification_blocklist_service_1.VerificationBlocklistService],
    })
], MerchantModule);
