...
class CancelOrderDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { reason: { required: false, type: () => String, minLength: 0, maxLength: 300 } };
    }
}
exports.CancelOrderDto = CancelOrderDto;
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, example: 'Changed my mind', description: 'Cancellation reason' }),
