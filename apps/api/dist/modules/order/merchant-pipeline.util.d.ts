...
export declare const MERCHANT_LIVE_STATUS_GROUPS: {
    readonly incoming: readonly [any, any];
    readonly preparation: readonly [any];
    readonly packing: readonly [any];
    readonly ready: readonly [any];
    readonly dispatch: readonly [any, any, any];
};
export declare const MERCHANT_ACTIVE_LIVE_STATUSES: any[];
